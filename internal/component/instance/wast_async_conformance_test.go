...
//   - (dont-block-start and trap-if-block-and-sync, once listed here, are
//     both resolved -- see async_builtins.go's blockingTask and thread.go's
//     threadSuspendHostFunc.)
