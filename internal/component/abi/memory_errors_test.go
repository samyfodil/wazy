...
func TestRecordFieldMismatch(t *testing.T) {
	...
	_, err := storeRecord(mem, 0, value, desc, nil, ReallocFunc(func(_, _, _, _ uint32) (uint32, error) { return 0, nil }))
	if err == nil {
...
func TestTupleElementMismatch(t *testing.T) {
	...
	_, err := storeTuple(mem, 0, value, desc, nil, ReallocFunc(func(_, _, _, _ uint32) (uint32, error) { return 0, nil }))
	if err == nil {
...
func TestListWrongType(t *testing.T) {
	...
	_, err := storeList(mem, 0, "not a list", desc, nil, ReallocFunc(func(_, _, _, _ uint32) (uint32, error) { return 0, nil }))
	if err == nil {
...
func TestResultWrongType(t *testing.T) {
	...
	_, err := storeResult(mem, 0, "not a result", desc, 0, nil, ReallocFunc(func(_, _, _, _ uint32) (uint32, error) { return 0, nil }))
	if err == nil {
...
func TestResultIsErrWrongType(t *testing.T) {
	...
	_, err := storeResult(mem, 0, map[string]any{"isErr": "not bool"}, desc, 0, nil, ReallocFunc(func(_, _, _, _ uint32) (uint32, error) { return 0, nil }))
	if err == nil {
...
func TestStoreRecordFieldTypeError(t *testing.T) {
	...
	_, err := storeRecord(mem, 0, value, desc, badResolve, ReallocFunc(func(_, _, _, _ uint32) (uint32, error) { return 0, nil }))
	if err == nil {
...
func TestStoreListFieldTypeError(t *testing.T) {
	...
	_, err := storeList(mem, 0, value, desc, badResolve, ReallocFunc(func(_, _, _, _ uint32) (uint32, error) { return 0, nil }))
	if err == nil {
...
func TestStoreF32WrongType(t *testing.T) {
	mem := make([]byte, 100)
	_, err := storePrimitive(mem, 0, "f32", "not float", ReallocFunc(func(_, _, _, _ uint32) (uint32, error) { return 0, nil }))
	if err == nil {
...
func TestStoreF64WrongType(t *testing.T) {
	mem := make([]byte, 100)
	_, err := storePrimitive(mem, 0, "f64", "not float", ReallocFunc(func(_, _, _, _ uint32) (uint32, error) { return 0, nil }))
	if err == nil {
...
func TestStoreStringWrongType(t *testing.T) {
	mem := make([]byte, 100)
	_, err := storePrimitive(mem, 0, "string", 42, ReallocFunc(func(_, _, _, _ uint32) (uint32, error) { return 0, nil }))
	if err == nil {
...
func TestStoreOptWithMissingPayloadType(t *testing.T) {
	...
	_, err := storeOption(mem, 0, uint32(42), desc, 0, nil, ReallocFunc(func(_, _, _, _ uint32) (uint32, error) { return 0, nil }))
	if err != nil {
