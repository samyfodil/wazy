...
import "github.com/samyfodil/wazy/internal/engine/wazevo/ssa"
...
// against wazevo.executionContext.stackBottomPtr -- it does not change how
...
//  2. wazevo frames are fixed-size: once a function's prologue check
...
//  4. The stack-grow path (wazevoapi.ExitCodeGrowStack), on the rare
