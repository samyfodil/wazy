...
import (
	...
	"github.com/samyfodil/wazy/internal/engine/wazevo/backend/isa/arm64"
...
func unwindStackForThrow(sp, _, top uintptr, frames []wazevoapi.ThrowFrame) []wazevoapi.ThrowFrame {
...
func resolveThrowTransferSPFP(fr wazevoapi.ThrowFrame, _ int64) (sp, fp uintptr) {
	return fr.SP, 0
}
