...
func (m *machine) emitTrapIslands() {
	...
	for _, ti := range m.trapIslands {
		...
		*mode = addressMode{
			...
			rn:   tmpRegVReg, imm: nativeapi.ExecutionContextOffsetExitCodeOffset.I64(),
		}
		...
		*mode2 = addressMode{
			kind: addressModeKindRegUnsignedImm12,
			rn:   tmpRegVReg, imm: nativeapi.ExecutionContextOffsetStackPointerBeforeGoCall.I64(),
		}
		...
		*mode3 = addressMode{
			kind: addressModeKindRegUnsignedImm12,
			rn:   tmpRegVReg, imm: nativeapi.ExecutionContextOffsetGoCallReturnAddress.I64(),
		}
	...
	*amode = addressMode{
	...
	// Set the required stack size and set it to the exec context.
	{
		...
		*amode = addressMode{
			...
			rn: x0VReg, imm: nativeapi.ExecutionContextOffsetStackGrowRequiredSize.I64(),
		}
...
func (m *machine) CompileStackGrowCallSequence() []byte {
	...
	cur = m.setExitCode(cur, x0VReg, nativeapi.ExitCodeGrowStack)
