...
TEXT ·afterGoFunctionCallEntrypoint(SB), NOSPLIT|NOFRAME, $0-32
	...
	// Save the current FP(R29), SP and LR(R30) into the native.executionContext (stored in R0).
...
// backend/isa/arm64/abi_go_call.go) from native.executionContext.savedRegisters
...
TEXT ·afterThrowTransferEntrypoint(SB), NOSPLIT|NOFRAME, $0-32
	...
	// native.executionContext (R0), exactly like afterGoFunctionCallEntrypoint,
