...
func TestEncodings_againstClang(t *testing.T) {
	...
	cases := []tc{
		...
		{"vfwcvt.f.x.v v1, v2", encodeVecUnary(vfunctFunary0, 1, 2, vsubFwcvtFX, opfvv)},
		{"vfwcvt.f.xu.v v1, v2", encodeVecUnary(vfunctFunary0, 1, 2, vsubFwcvtFXu, opfvv)},
		{"vfncvt.rtz.x.f.w v1, v2", encodeVecUnary(vfunctFunary0, 1, 2, vsubFncvtRtzX, opfvv)},
		{"vfncvt.rtz.xu.f.w v1, v2", encodeVecUnary(vfunctFunary0, 1, 2, vsubFncvtRtzXu, opfvv)},
		{"vmax.vx v1, v2, x3", encodeVecVX(vfunctMax, 1, 2, 3)},
		{"vmflt.vf v0, v1, f2", encodeVecVV(vfunctMflt, 0, 1, 2, opfvf)},
		{"vfsgnjx.vv v1, v2, v2", encodeVecVV(vfunctFsgnjx, 1, 2, 2, opfvv)},
		{"vmerge.vim v1, v2, -1, v0", encodeVmergeVI(1, 2, -1)},
		{"vsetivli zero, 2, e32, mf2, tu, ma", encodeVsetivliLMulTU(2, vsew32, vlmulMF2)},
		...
		{"vsetivli zero, 8, e16, mf2, ta, ma", encodeVsetivliLMul(8, vsew16, vlmulMF2)},
		{"vsetivli zero, 2, e32, mf2, ta, ma", encodeVsetivliLMul(2, vsew32, vlmulMF2)},
		{"vsetivli zero, 8, e8, mf2, ta, ma", encodeVsetivliLMul(8, vsew8, vlmulMF2)},
