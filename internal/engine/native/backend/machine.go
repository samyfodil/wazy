...
type (
	...
	Machine interface {
		...
		CompileGoFunctionTrampoline(exitCode nativeapi.ExitCode, sig *ssa.Signature, needModuleContextPtr bool) []byte
		...
		// native.executionContext.savedRegisters, plain return out) used by
