...
func (v Value) formatWithType(b Builder) (ret string) {
	...
	if nativeapi.SSALoggingEnabled { // This is useful to check live value analysis bugs.
...
type Values = nativeapi.VarLength[Value]

// ValuesNil is a nil Values.
var ValuesNil = nativeapi.NewNilVarLength[Value]()
