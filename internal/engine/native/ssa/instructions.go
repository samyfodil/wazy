...
func (i *Instruction) AsReturn(vs nativeapi.VarLength[Value]) *Instruction {
...
func (i *Instruction) AsExitWithCode(ctx Value, code nativeapi.ExitCode) {
...
func (i *Instruction) AsExitIfTrueWithCode(ctx, c Value, code nativeapi.ExitCode) *Instruction {
...
func (i *Instruction) ExitWithCodeData() (ctx Value, code nativeapi.ExitCode) {
	return i.v, nativeapi.ExitCode(i.u1)
}

// ExitIfTrueWithCodeData returns the context and exit code of OpcodeExitWithCode.
func (i *Instruction) ExitIfTrueWithCodeData() (ctx, c Value, code nativeapi.ExitCode) {
	return i.v, i.v2, nativeapi.ExitCode(i.u1)
}
...
func (i *Instruction) Format(b Builder) string {
	...
	case OpcodeExitWithCode:
		instSuffix = fmt.Sprintf(" %s, %s", i.v.Format(b), nativeapi.ExitCode(i.u1))
	case OpcodeExitIfTrueWithCode:
		instSuffix = fmt.Sprintf(" %s, %s, %s", i.v2.Format(b), i.v.Format(b), nativeapi.ExitCode(i.u1))
