	...
	for _, tc := range []struct {
		...
		},
		{
			...
			exp: ModuleContextOffsetData{
				...
				BeforeListenerTrampolines1stElement: -1,
				AfterListenerTrampolines1stElement:  -1,
				DataInstances1stElement:             32,
				ElementInstances1stElement:          40,
		...
		},
		{
			...
			exp: ModuleContextOffsetData{
				...
				BeforeListenerTrampolines1stElement: -1,
				AfterListenerTrampolines1stElement:  -1,
				DataInstances1stElement:             10*FunctionInstanceSize + 32,
				ElementInstances1stElement:          10*FunctionInstanceSize + 40,
				TotalSize:                           int(align16(Offset(10*FunctionInstanceSize + 48))),
			},
		},
		{
