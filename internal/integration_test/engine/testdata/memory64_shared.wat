...
(module
  ...
  (func (export "wait64") (param i64 i64) (result i32)
    (memory.atomic.wait64 (local.get 0) (local.get 1) (i64.const 0)))
  (func (export "rmw_add64") (param i64 i64) (result i64)
    (i64.atomic.rmw.add (local.get 0) (local.get 1)))
  (func (export "cmpxchg64") (param i64 i64 i64) (result i64)
    (i64.atomic.rmw.cmpxchg (local.get 0) (local.get 1) (local.get 2)))
)
