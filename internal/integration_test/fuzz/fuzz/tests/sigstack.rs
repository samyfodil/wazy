...
fn main() {
    unsafe {
        let sa = SigAction::new(
            ...
            // of native function because it uses "Go allocated" stack.
            //
            // On the other hand, this is more of a general problem for any C program that uses Go as a library,
            // not limited to native, when it does not not install sig handlers with SA_ONSTACK. That means
            ...
            //
            // To reproduce the failure in native, Use SaFlags::empty() and nativeapi.StackGuardCheckEnabled=true.
            //
