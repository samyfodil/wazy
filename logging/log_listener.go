...
import (
	...
	aslogging "github.com/samyfodil/wazy/internal/assemblyscript/logging"
	"github.com/samyfodil/wazy/internal/logging"
	"github.com/samyfodil/wazy/internal/wasip1"
	wasilogging "github.com/samyfodil/wazy/internal/wasip1/logging"
)
...
// NewLoggingListenerFactory is an api.FunctionListenerFactory that
...
func NewLoggingListenerFactory(w Writer) api.FunctionListenerFactory {
	return &loggingListenerFactory{w: toInternalWriter(w), scopes: LogScopeAll}
}

// NewHostLoggingListenerFactory is an api.FunctionListenerFactory
...
func NewHostLoggingListenerFactory(w Writer, scopes logging.LogScopes) api.FunctionListenerFactory {
...
// loggingListener implements api.FunctionListener to log entrance and after
...
func (l *loggingListener) Before(ctx context.Context, mod api.Module, def api.FunctionDefinition, params []uint64, _ api.StackIterator) {
