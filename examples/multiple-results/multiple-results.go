...
func resultOffsetWasmFunctions(ctx context.Context, r wazy.Runtime) (api.Module, error) {
...
func multiValueWasmFunctions(ctx context.Context, r wazy.Runtime) (api.Module, error) {
