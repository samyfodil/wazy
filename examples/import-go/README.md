...
export functions using [HostModuleBuilder](https://pkg.go.dev/github.com/samyfodil/wazy#HostModuleBuilder) and how a
...
The following examples continue the path of learning about importing and exporting functions with wazy:
...
[(WASI)](https://github.com/WebAssembly/WASI). While this is not yet a W3C standard, wazy includes a
[wasi package](https://pkg.go.dev/github.com/samyfodil/wazy/wasi).
