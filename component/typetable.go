...
//
// The Add method is the primitive; the sugar methods below (List, Map,
// Option, Result, Tuple, Record, Variant) cover the shapes that actually
// occur and keep TypeRef out of caller code:
//
