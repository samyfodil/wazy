...
func (u uniqGoFuncs) NewFunctionListener(def api.FunctionDefinition) api.FunctionListener {
...
func (u uniqGoFuncs) Before(ctx context.Context, _ api.Module, def api.FunctionDefinition, _ []uint64, _ api.StackIterator) {
...
func Example_customListenerFactory() {
	...
	ctx := api.WithFunctionListenerFactory(context.Background(), u)
...
func (s *fakeStackIterator) Function() api.InternalFunction {
...
func (s *fakeStackIterator) ProgramCounter() api.ProgramCounter {
	return api.ProgramCounter(s.pc)
}

var _ api.StackIterator = &fakeStackIterator{}
